...
public class UseInterrupts
{
    ...
    public static void main(String[] args) {
        sbu.cs.UseInterrupts.SleepThread sleepThread = new sbu.cs.UseInterrupts.SleepThread(5);
        sleepThread.start();
        ...
        sbu.cs.UseInterrupts.LoopThread loopThread = new sbu.cs.UseInterrupts.LoopThread(3);
        loopThread.start();
